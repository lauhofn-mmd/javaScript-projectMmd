...
const translation = {
    dk: {
        ...
        p: "Vores olier er ikke blot skabt med omtanke på renhed og bæredygtighed, men også ud fra principper om medfølelse til alle jordens skabninger. Vi tror på at enhver selvplejende rutine tager udgangspunkt i omtanke, betænksomhed og respekt for andre væsener og derfor er vores produkter 100 % veganske og uden nogen form for animalske ingredienser.",
        p: "Dette betyder også, at du kan være sikker på, at vores olier er produceret ud fra klare etiske standarder, uden nogen form for dyreforsøg. Ved at købe cruelty-free produkter, er du med til at bane vej for en fremtid, hvor respekt for dyr og skønhedspleje går hånd i hånd.",
        p: "Tilmeld dig vores e-mail-liste for eksklusive tilbud og de seneste nyheder.",
        p: "Danish Webstore Group ApS",
        p: "Møllevej 2A",
        p: "9240 Nibe",
        p: "CVR: 37640263",
        p: "Mail: info@oilsbynature.dk",
        p: "Nem bestilling og hurtig levering.",
        p: "Vi afsender alle ordrer dagligt",
        p: "Hurtig levering på 2-4 dage.",
        p: "Forretningsbetingelser",
        p: "Cookie- og privatlivspolitik",
        p: "Vi værdsætter din mening!",
        p: "Sørg for at bedømme din oplevelse på Trustpilot",
        h3: "Olier af natur",
        h3: "Sikker forsendelse",
        h3: "Menu",
        h3: "Kontakt",
        h3: "Arbejd hos os",
        h3: "Returret",
